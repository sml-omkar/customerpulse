        ...
        <div className="space-y-6 font-sans">
              ...
              <div className="bg-white border border-slate-200/80 shadow-sm rounded-2xl overflow-hidden">
                <div className="overflow-x-auto">
                  <table className="min-w-[900px] w-full divide-y divide-slate-100 text-xs">
                    <thead className="bg-slate-50/75 text-slate-500 font-semibold uppercase tracking-wider">
                      <tr>
                    ...
                    <tbody className="divide-y divide-slate-100 text-slate-700">
                      {loading ? (
                        <tr><td colSpan={6} className="px-6 py-6 text-center text-slate-400">Loading...</td></tr>
                      ) : (filteredStaff.length === 0 && filteredRequestors.length === 0) ? (
                        <tr><td colSpan={6} className="px-6 py-6 text-center text-slate-400 italic">No users match this filter.</td></tr>
                      ) : (
                        <>
                            ...
                            <tr key={`requester-${r.id}`} className="hover:bg-slate-50/50 transition-colors align-top">
                              ...
                              <td className="px-6 py-4 whitespace-nowrap">
                                <div className="flex flex-col gap-1">
                                  <span className={`px-2.5 py-1 rounded-full font-semibold text-[10px] border w-fit ${
